	...
	<div style="min-height: 100vh; position: relative;">
		...
		<div class="titleSticky">
			<div class="titleInnerDiv">
				<h1 class="greenBack">ご予約キャンセルの確認</h1>
			</div>
		</div>
		...
		<center>
			<div class="tableDiv bgBlur">
				<div class="flex-container">
					<div class="formDiv">
						<h2>
							下部のご予約キャンセルボタンを押すと<br />キャンセルが確定されます。
						</h2>
					</div>
					<div class="flex-item">
						<h2>ご予約日時</h2>
				...
				<div
					...
					<div>
						<form action="<%=SvlUlrl.ReserveOperationSvl%>">
							<input type="hidden" value="<%=ReserveOperationSvl.DELETE%>"
								name="<%=ReserveVar.mode%>" /> <input type="hidden"
								name="<%=ReserveVar.rsvId%>" value="<%=re.getRsvId()%>" /> <input
								class="button enterButton" type="submit" value="ご予約のキャンセル" />
						</form>
					</div>
				</div>
			</div>
