 ...
 * Generated at: 2021-04-05 01:23:28 UTC
...
return;
    ...
    try {
      ...
      out.write("<title>お客様情報変更画面</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if (us != null) {
      ...
      out.write("\t\t\t\t\t<h1 class=\"greenBack\">お客様情報変更</h1>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<form name=\"insert\" action=\"/ideal/controller/UserOperationSvl\"\r\n");
      out.write("\t\t\t\t\t\tmethod=\"post\" onsubmit=\"return userInsertCheck(this);\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"formDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">[必須]お名前</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"inputDef\" type=\"text\" name=\"usrName\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(FormReplacer.fmtNull(us2.getUsrName()));
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">郵便番号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\" id=\"status\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"inputDef\" id=\"zipcode\" type=\"text\" name=\"zipcode\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(FormReplacer.fmtNull(us2.getZipcode()));
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"button formButton\" id=\"searchBtn\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvalue=\"検索\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">住所</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input id=\"address\" class=\"inputDef\" type=\"text\" name=\"address\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(FormReplacer.fmtNull(us2.getAddress()));
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">電話番号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"inputDef\" type=\"text\" name=\"phone\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(FormReplacer.fmtNull(us2.getPhone()));
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">[必須]e-mail</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\" id=\"mailMessage\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"inputDef\" id=\"mailadd\" type=\"text\" name=\"mail\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(FormReplacer.fmtNull(us2.getMail()));
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"button formButton\" id=\"mailid\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvalue=\"メール\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">[必須]今のパスワード</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"inputDef\" type=\"password\" name=\"password\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"formDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"tableDef\">新しいパスワード</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"inputDef\" type=\"password\" name=\"newPassword\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"usrId\" name=\"usrId\" value=\"");
      out.print(us2.getUsrId());
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"mode\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
      out.print(UserOperationSvl.UPDATE);
      out.write("\" />\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\tstyle=\"margin-top: 3em; display: flex; justify-content: center;\">\r\n");
      out.write("\t\t\t\t\t<a class=\"button enterButton\" href=\"/ideal/home.jsp\">ホームページに戻る</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<script src=\"/ideal/js/userUpdateCheck.js\" type=\"text/javascript\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
