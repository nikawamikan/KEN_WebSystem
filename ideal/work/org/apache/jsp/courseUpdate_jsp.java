 ...
 * Generated at: 2021-04-02 01:08:53 UTC
...
String[] selectName = { "appetizerID", "soupID", "pastaID", "meatID",
  ...
  static {
    ...
    _jspx_dependants.put("/adminHeader.jsp", Long.valueOf(1617320361997L));
  }
  ...
  static {
    ...
    _jspx_imports_packages.add("general");
...
return;
    ...
    try {
      ...
      out.write("<title>コース変更画面</title>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tfunction check() {\r\n");
      out.write("\t\tif (document.courseInsert.courseName.value == \"\") {\r\n");
      out.write("\t\t\twindow.alert(\"メニュー名が未入力です。\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t} else if (document.courseInsert.price.value == \"\") {\r\n");
      out.write("\t\t\twindow.alert(\"価格が未入力です。\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t} else if (priceRegexCheck(document.courseInsert.price.value)) {\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- requestscopeからArrayListに格納されたMenuクラス型の\"typeMenuList\"を取得 -->\r\n");
      out.write("\t");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<!-- requestscopeからArrayListに格納されたMenuクラス型の\"menu\"を取得 -->\r\n");
      out.write("\t");
	...
	Admin amd = (Admin) session.getAttribute(AdminVar.adminInfo);
      ...
      out.write("\t\t\t\t<h1 class=\"greenBack\">コースの変更</h1>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<form id=\"courseInsert\" name=\"courseInsert\"\r\n");
      out.write("\t\t\t\t\taction=\"");
      out.print(SvlUlrl.CourseOperationSvl);
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"tableDef\">コース名</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"inputDef\" id=\"courseName\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"courseName\" value=\"");
      ...
      out.print(FormReplacer.checkeder(oneCourse.getOrderFlg(), 1));
      out.write("/>可\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"orderFlg\" value=\"0\" ");
      out.print(FormReplacer.checkeder(oneCourse.getOrderFlg(), 0));
      out.write("/>不可\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"tableDef\">");
      out.print(typeName[i]);
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<select class=\"inputDef\" id=\"");
      out.print(selectName[i]);
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"");
      out.print(selectName[i]);
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"0\">");
      out.print(typeName[i] + "の追加はしない");
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.print(FormReplacer.fmtNull(oneCourse.getDetail()) );
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\ttype=\"hidden\" name=\"courseID\"\r\n");
      out.write("\t\t\t\t\t\t\t\tvalue=\"");
