 ...
 * Generated at: 2021-04-01 00:32:00 UTC
...
return;
    ...
    try {
      ...
      out.write("<title>メニュー登録画面</title>\r\n");
      out.write("\r\n");
	...
	Admin amd = (Admin) session.getAttribute(AdminVar.adminInfo);
      ...
      out.write("\t\t\t\t<h1 class=\"greenBack\">新規メニュー登録</h1>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t");
      ...
      out.print(((MenuType) mt).getTypeID());
      out.write('"');
      out.write(' ');
      out.print(selected);
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      out.print(((MenuType) mt).getTypeName());
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
