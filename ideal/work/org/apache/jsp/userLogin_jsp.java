 ...
 * Generated at: 2021-04-05 00:42:00 UTC
...
return;
    ...
    try {
      ...
      out.write("<title>顧客ログイン画面</title>\r\n");
      ...
      out.write("\t\tif (document.login.usrId.value == \"\") {\r\n");
      out.write("\t\t\twindow.alert(\"IDが未入力です。\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t} else if (idRegexCheck(document.login.usrId.value)) {\r\n");
      out.write("\t\t\twindow.alert(\"IDは数字で入力してください。\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\r\n");
      out.write("\t\t} else if (document.login.password.value == \"\") {\r\n");
      out.write("\t\t\twindow.alert(\"パスワードが未入力です。\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t} else if (passwordRegexCheck(document.login.password.value)) {\r\n");
      out.write("\t\t\twindow.alert(\"パスワードは英数字で入力してください。\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\treturn true;\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction idRegexCheck(pass) {\r\n");
      out.write("\t\tconst\r\n");
      out.write("\t\tregex = new RegExp('^[0-9]+$');\r\n");
      out.write("\t\treturn !regex.test(pass);\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction passwordRegexCheck(pass) {\r\n");
      out.write("\t\tconst\r\n");
      out.write("\t\tregex = new RegExp('^[a-zA-Z0-9]+$');\r\n");
      out.write("\t\treturn !regex.test(pass);\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
	...
	if (us != null) {
      ...
      out.write("\t\t\t\t<h1 class=\"greenBack\">ログイン</h1>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t\t\taction=\"/ideal/controller/UserLoginSvl\" method=\"post\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"tableDef\">e-mail</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"tableDef\">パスワード</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input class=\"button enterButton\" type=\"submit\" value=\"ログイン\" />\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t<h2>アカウントをお持ちでないですか？<br/><a href=\"/ideal/userInsert.jsp\" style=\"color: #55ee44\">こちら</a>で新しくアカウントを作成できます。</h2>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
