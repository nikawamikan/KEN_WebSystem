 ...
 * Generated at: 2021-04-05 00:43:55 UTC
...
return;
	...
	if (us != null) {
      ...
      out.write("\t\t\t\t<h1 class=\"redBack\">管理者ログイン</h1>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t");
      ...
      out.print( SvlUlrl.AdminLoginSvl );
      out.write("\" method=\"post\" onsubmit=\"return adminLoginCheck(this)\" >\r\n");
      ...
      out.write("\t\t\t\t\t<h2>ここは管理者ログインページです。<br/>\r\n");
      out.write("\t\t\t\t\tお客様がログインされる場合はログインボタンからログインしてください</h2>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"formDiv\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"formDivInner\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"titleDiv\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"tableDef\">ユーザー名</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"inputDef\" type=\"text\" name=\"admName\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"messageDiv\"></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input class=\"button enterButton\" type=\"submit\" value=\"管理者としてログイン\" />\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</center>\r\n");
